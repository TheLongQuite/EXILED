...
namespace Exiled.CustomRoles
{
    ...
    public class Config : IConfig
    {
        ...
        public Hint GotRoleHint { get; } = new("You have spawned as a {0}\n{1}", 6);
        ...
        public Hint UsedAbilityHint { get; } = new("Ability {0} has been activated.\n{1}", 5);

        /// <summary>
        ///     Gets the hint that is shown when someone used a <see cref="CustomAbility" />.
        /// </summary>
        [Description("The hint that is shown when someone's custom ability is ready.")]
        public Hint AbilityReadyHint { get; } = new("Ability {0} is ready.\n{1}", 5);
        ...
        public Hint AbilityOnCooldownHint { get; } = new("Способность на перезарядке!\nПодождите ещё {0} секунд перед использованием.", 5);
        ...
        public Hint InsufficientEnergyHint { get; } = new("Недостаточно энергии!\nУ вас {0}/{1}", 5);
        ...
        public Hint InsufficientLevelHint { get; } = new("Недостаточный уровень!\nУ вас {0}/{1}", 5);
        ...
        public Hint RedundantLevelHint { get; } = new("Избыточный уровень!\nУ вас {0}/{1}", 5);
